...
?>
<div class="shipping row my-3">
	<div class="col-12">
		<h6 class="text-uppercase font-weight-bold mb-4">Доставка</h6>
	</div>
	<div class="col-12" data-title="<?php echo esc_attr( $package_name ); ?>">
		...
		<?php elseif ( 1 === count( $available_methods ) ) :  ?>
			...
			<div class="row no-gutters">
				<div class="col-lg-1"><img src="/img/shipping.jpg" alt="Доставка"></div>
				<div class="col-lg-1"></div>
				<div class="col-lg-7">
					<p class="shipping-name mb-0">Курьером при заказе от 3000 ₽</p>
					<p>Москва и Московская обл.</p>
				</div>
				<div class="col-lg-2 text-center"><img src="/img/<?= $method->method_id == 'free_shipping' ? 'checked.jpg' : 'unchecked.jpg';?>" alt="" width="30"></div>
				<div class="col-lg-1">300 ₽</div>
			</div>
			<?php
